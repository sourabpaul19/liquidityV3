...
export default function NewAccount() {
  ...
  const slides = [
    ...
    { id: 2, img: "/images/bar.jpg", title: "Discover New Adventures" },
    { id: 3, img: "/images/event.png", title: "Your Journey Begins Here" },
    { id: 4, img: "/images/login_bg.jpg", title: "Dream. Explore. Travel." },
    { id: 5, img: "/images/account_bg.jpg", title: "Dream. Explore. Travel." },
  ];
            ...
            >
              <div className="grid grid-cols-1 gap-4">
                {distances.map((distance) => (
                  <label
                    key={distance.id}
                    className={`cursor-pointer flex items-center justify-between transition ${tempSelectedDistance?.id === distance.id
                      ? "border-primary"
                      : "border-gray-200"
                      }`}
                  >
                    ...
                    <span className="text-sm ml-4 mr-auto text-center">{distance.name}</span>
                    <input
                      type="radio"
                      name="distance"
                      value={distance.id}
                      checked={tempSelectedDistance?.id === distance.id}
                      onChange={() => setTempSelectedDistance(distance)}
                    />
                  </label>
                ))}
              </div>

...
import { ChevronDown } from "lucide-react"; // ✅ added Trash2 icon
...
export default function OTPVerify() {
    ...
    const handleVerify = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        router.push("/acknowledgement"); // ✅ navigate client-side
    };
            ...
            <div className={`${styles.itemCard}`}>
                ...
                <div className={styles.itemRight}>
                    ...
                    <QuantityButton
                        ...
                        onDelete={() => console.log("Item removed")} // ✅ optional delete callback
                    />

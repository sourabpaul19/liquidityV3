...
import success from '../../../public/images/success-icon.png';
import Hurrah from '../../../public/images/Hurrah.svg';
    ...
    <section className='page_content'>
        <div className={styles.successWrapper}>
            <div className={styles.successIcon}>
                <Image src={success} alt="" fill />
            </div>
            <div className={styles.successText}>
                <Image src={Hurrah} alt="" fill />
            </div>
            <h4 className="text-center mb-4">Your Order has been Successfully Placed</h4>
            ...
            <div className="bottomButton">
                <Button href="/order-success">Check the status of my order</Button>
            </div>
        </div>
    </section>
    <BottomNavigation />

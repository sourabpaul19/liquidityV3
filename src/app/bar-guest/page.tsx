...
import styles from "./bar-guest.module.scss";
...
export default function GuestPage() {
  ...
  useEffect(() => {
    const fetchShopData = async () => {
      try {
        const response = await fetch('https://backend.liquiditybars.com/admin/api/fetchDashboardDataForTempUsers');

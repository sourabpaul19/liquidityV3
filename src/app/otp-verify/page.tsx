...
export default function OTPVerify() {
  ...
  const transferFromTempCart = async (
    ...
    try {
      ...
      const res = await fetch(
        "https://backend.liquiditybars.com/admin/api/transferFromTempCart",
        {
          method: "POST",
          headers: { "Content-Type": "application/x-www-form-urlencoded" },
          body: body.toString(),
  ...
  const clearUserCart = async (userId: string): Promise<boolean> => {
    try {
      const url = `https://backend.liquiditybars.com/admin/api/clearCartForUser/${userId}`;
  ...
  const handleVerify = async (e: FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://backend.liquiditybars.com/admin/api/otpVerification/",
        {
          method: "POST",
          headers: { "Content-Type": "application/x-www-form-urlencoded" },

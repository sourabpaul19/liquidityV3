...
export default function CardManager({ userId }: { userId: string }) {
  ...
  async function fetchCards() {
    try {
      const res = await fetch(
        `https://backend.liquiditybars.com/admin/api/fetchCards/${userId}`
      );
  ...
  async function saveCard() {
    ...
    try {
      const res = await fetch(
        "https://backend.liquiditybars.com/admin/api/saveCards/",
        {
          method: "POST",
  ...
  async function deleteCard(cardId: string) {
    try {
      const res = await fetch(
        `https://backend.liquiditybars.com/admin/api/deleteCard/${cardId}`,
        { method: "GET" }
      );
